...
const TestAscii = () => {
	...
	const [floor, setFloor] = useState<number>(50);
	...
	const [baseImageOpacity, setBaseImageOpacity] = useState<number>(0);
	const [pixelsOpacity, setPixelsOpacity] = useState<number>(0);
