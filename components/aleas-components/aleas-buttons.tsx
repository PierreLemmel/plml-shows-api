...
const AleasBaseButton = (props: BaseButtonProps) => {
    ...
    const isActuallySpinning = spinning || innerSpinning;
    ...
    return <div
        ...
        className={mergeClasses(
            sharedClasses,
            disabled === true ? disabledClasses : (isActuallySpinning === true ? spinningClasses : enabledClasses),
            match(size, {
                ["Normal"]: mergeClasses(
                    "py-3 px-6 min-w-[8em]",
    ...
    >
        {isActuallySpinning ? <svg className="animate-spin h-5 w-5" viewBox="0 0 24 24">
